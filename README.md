# Score-Agnostic Structure Clustering 

This repository provides code to identify structural groupings in large-scale transcribed solo piano performance datasets, without relying on a score.
